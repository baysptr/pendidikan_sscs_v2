    ...
    <body class="hold-transition skin-blue sidebar-mini">
                                ...
                                <tbody>
                                    <?php foreach ($data_menu as $menu) { ?>
                                        <tr>
                                            <td><?= $menu['menu'] ?></td>
                                            <td><?= $menu['link'] ?></td>
                                            <td><div class="btn btn-xs btn-danger" onclick="hapus('<?= $menu['id'] ?>')"><span class="glyphicon glyphicon-trash"></span></div></td>
                                            <td><div class="btn btn-xs btn-success" onclick="show('<?= $menu['id'] ?>')"><span class="glyphicon glyphicon-edit"></span></div></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
                        ...
                        <form id="form" method="post">
                            ...
                            <table class="table table-responsive table-hover table-condensed">
                                <tr>
                                    <td><b>Nama Menu</b></td>
                                    <td>:</td>
                                    <td><input type="text" name="menu" id="menu" class="form-control"></td>
                                </tr>
                                <tr>
                                    <td><b>Link Menu</b></td>
                                    <td>:</td>
        ...
        <script type="text/javascript">
                                            ...
                                            function show(id) {
                                                ...
                                                $.ajax({
                                                    url: "<?= site_url() ?>/admin/show_menu/" + id,
                                                    type: 'GET',
                                                    dataType: 'JSON',
                                            ...
                                            function hapus(id) {
                                                if (confirm("Apakah anda yakin menghapus ???") === true) {
                                                    $.ajax({
                                                        url: "<?php echo site_url('admin/delete_menu') ?>/" + id,
                                                        type: "POST",
                                                        dataType: "JSON",
                                                        success: function (data)
                                                        {
