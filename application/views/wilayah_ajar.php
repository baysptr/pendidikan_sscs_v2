...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <td colspan="2" width="10%">
                                            <div class="btn btn-sm btn-block btn-primary" onclick="add()"><span class="glyphicon glyphicon-plus-sign"></span></div>
                                        </td>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn btn-xs btn-block btn-danger" onclick="hapus('<?= $wilayah['id'] ?>')"><span class="glyphicon glyphicon-trash"></span></div>
                                        </td>
                                        <td>
                                            <div class="btn btn-xs btn-block btn-primary" onclick="show('<?= $wilayah['id'] ?>')"><span class="glyphicon glyphicon-edit"></span></div>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
        ...
        <script type="text/javascript">
                                            ...
                                            function add() {
                                                method = "add";
                                                $(".modal-title").text("Form Tambah Wilayah Ajar");
                                                $("#myModal").modal("show");
                                            }
                                            ...
                                            function show(id) {
                                                ...
                                                $.ajax({
                                                    url: "<?= site_url() ?>/admin/show_wilayah_ngajar/" + id,
                                                    type: 'GET',
                                                    dataType: 'JSON',
                                                    success: function (data) {
                                                        $(".modal-title").text("Form Ubah Wilayah");
                                                        $("#id").val(data.id);
                                            ...
                                            function hapus(id) {
                                                if (confirm("Apakah anda yakin menghapus ???") === true) {
                                                    $.ajax({
                                                        url: "<?php echo site_url('admin/delete_wilayah_ajar') ?>/" + id,
                                                        type: "POST",
                                                        dataType: "JSON",
                                                        success: function (data)
                                                        {
                                            ...
                                            function save() {
                                                var url;
                                                if (method === "add") {
                                                    url = "<?= site_url() ?>/admin/add_wilayah_ngajar";
                                                } else {
                                                    url = "<?= site_url() ?>/admin/update_wilayah_ngajar";
                                                }
