    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="<?= base_url() ?>components/index2.html"><b>Admin</b>LTE</a>
            </div>
            <!-- /.login-logo -->
            <div class="login-box-body">
                <p class="login-box-msg">Sign in to start your session</p>

                <form action="<?= site_url() ?>/welcome/do_login" method="post">
                ...
                <a href="<?= site_url() ?>/welcome/register" class="text-center">Daftar Member</a>
