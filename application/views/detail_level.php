...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Menu Link di Menu <b><?= $data_level->level ?></b></h3>
                        ...
                        <div class="box-body">
                            <table class="table table-condensed table-hover">
                                ...
                                <tbody>
                                    <?php foreach ($data_d_level as $d_level) { ?>
                                    <tr>
                                        <td><?= $d_level['menu'] ?></td>
                                        <td>
                                            <div class="btn btn-xs btn-danger" onclick="hapus('<?= $d_level['id'] ?>')"><span class="glyphicon glyphicon-trash"></span></div>
                                        </td>
                                        <td>
                                            <div class="btn btn-xs btn-primary" onclick="show('<?= $d_level['id'] ?>')"><span class="glyphicon glyphicon-edit"></span></div>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
        ...
        <script type="text/javascript">
                                            ...
                                            function add() {
                                                method = "add";
                                                $(".modal-title").text("Form Tambah Menu");
                                                $("#id_level").val('<?= $data_level->id ?>');
                                                $("#myModal").modal("show");
                                            }
                                            ...
                                            function show(id) {
                                                ...
                                                $.ajax({
                                                    url: "<?= site_url('admin/show_d_level') ?>/" + id,
                                                    type: 'GET',
                                                    dataType: 'JSON',
                                            ...
                                            function hapus(id) {
                                                if (confirm("Apakah anda yakin menghapus ???") === true) {
                                                    $.ajax({
                                                        url: "<?php echo site_url('admin/delete_d_level') ?>/" + id,
                                                        type: "POST",
                                                        dataType: "JSON",
                                                        success: function (data)
                                                        {
                                            ...
                                            function save() {
                                                var url;
                                                if (method === "add") {
                                                    url = "<?= site_url() ?>/admin/add_d_level";
                                                } else {
                                                    url = "<?= site_url() ?>/admin/update_d_level";
                                                }
